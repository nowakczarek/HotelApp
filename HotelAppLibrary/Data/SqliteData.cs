...
namespace HotelAppLibrary.Data
{
	public class SqliteData : IDatabaseData
	{
        ...
        public void BookGuest(string firstName, string lastName, DateTime startDate, DateTime endDate, int roomTypeId)
		{
			...
			sql = @"insert into Bookings (RoomId,GuestId,StartDate,EndDate,TotalCosts)
			...
			_db.SaveData(sql,
						 new
						 {
							 ...
							 startDate = startDate,
							 endDate = endDate,
							 totalCosts = timeStaying.Days * roomType.Price
						 },
						 connectionStringName);
		}
		...
		{
			string sql = @"select [b].[Id], [b].[RoomId], [b].[GuestId], [b].[StartDate], [b].[EndDate], [b].[CheckedIn], [b].[TotalCosts],
